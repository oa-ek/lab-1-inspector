                ...
                "render": function (data, type, row) {
                    ...
                    if (status === 'closed') {
                        return `<div class="w-75 btn-group" role="group">
                                <a href="#" onclick="ComplaintClosed()" class="btn btn-primary mx-2" style="opacity:0.6"><i class="bi bi-pencil-square"></i> Responce</a>
                                ...
                                <a href="#" onclick="ComplaintClosed()" class="btn btn-info mx-2" style="opacity:0.6"><i class="bi bi-forward"></i> Give To</a>
                            </div>`;
...
function ComplaintClosed() {
    Swal.fire('The complaint has already been closed!');
}